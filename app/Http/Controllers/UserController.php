...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            if (session('user')->id === 1) {
                $UserTbl =
                    UsersTbl::select(
                        ...
                        "users_tbls.full_name as full_name", "users_tbls.user_name as user_name",
                        "branch_tbls.branch_name as branch_name", "users_tbls.email as email", "role_tbls.role_name as role_name",
        ...
        if (session('user')->id === 1) {
            ...
            $branches = BranchTbl::all()->where('id', session('user')->branch_id)->first();
        }
        $roles = RoleTbl::all();
        $title = "Users";
        $pages = PageTbl::all();
    ...
    public function edit($id)
    {
        ...
        if ($data['getDataById'][0]->role_id != 3) {
            $data["staffs"] = StaffsTbl::all();
        } else {
            $data["staffs"] = StudentsTbl::all();
        }
