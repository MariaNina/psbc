...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Deductions Settings</h1>
...
@include('dashboard.modals.deduction')

@endsection

@section('extra-js')
<script src="{{ asset('js/form-scripts/deduction.js') }}"></script>
<script src="{{ asset('js/datatable-scripts/deduction.js') }}"></script>
@endsection