<!-- College Modal-->
<div class="modal fade" id="collegeCurriculumModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
	  <div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">
				Create New College Curriculum
			</h5>
			<button
				class="close"
				type="button"
		...
		{{-- Form --}}
		<form id="addCurriculumForm" role="form">
			@csrf
			<input type="hidden" value="College" name="studentDept">
				...
				<div class="form-group">
					...
					<select class="form-control border-radius-2" id="level" name="level" required>
						...
						@foreach ($college_levels as $college_level)
							<option value="{{ $college_level->id }}">{{ $college_level->level_name }}</option>
						@endforeach
					</select>
				</div>
				<div class="form-group">
					...
					<select class="form-control border-radius-2" id="programMajor" name="programMajor" required>
						<option disabled selected value="">Select...</option>
						@foreach ($programsMajorsCollege as $programsMajor)
...
<!-- College Modal-->
<div class="modal fade" id="editCollegeCurriculumModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
	  <div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">
				Update College Curriculum
			</h5>
			<button
				class="close"
				type="button"
		...
		{{-- Form --}}
		<form id="editCurriculumForm" role="form">
			@csrf
			<input type="hidden" value="College" name="studentDept">
			<div class="modal-body">
				<div class="form-group">
				...
				<div class="form-group">
					<label for="courseDescription">Curriculum Description</label>
					<textarea class="form-control form-control-textarea" name="curriculumDescription" id="upd_curriculumDescription" placeholder="Curriculum Description..." required></textarea>
				</div>
				<div class="form-group">
					<label for="schoolYear">Student Level</label>
					<select class="form-control border-radius-2" id="upd_level" name="level" required>
					</select>
				</div>
				<div class="form-group">
					<label for="programMajor">Program & Major</label>
					<select class="form-control border-radius-2" id="upd_programMajor" name="programMajor" required>
					</select>
				</div>
				<div class="form-group">
					<label for="schoolYear">School Year</label>
					<select class="form-control border-radius-2" id="upd_schoolYear" name="schoolYear" required>
					</select>
				</div>
