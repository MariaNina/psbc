            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        ...
                        <a class="d-none d-sm-inline-block btn btn-sm btn-orange shadow-sm createUser" href="#"
                            role="button" data-id="{{ $one->id + 1 }}" data-toggle="modal" data-target="#addUserModal">
