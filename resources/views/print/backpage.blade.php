...
<div class="container my-3">
    <div class="form-wrapper mb-1">
        <div class="d-flex justify-content-between mb-3">
            <h5>Student's Name:
                <span class="underline">{{$assessment->student->last_name}}, {{$assessment->student->first_name}}
                    {{$assessment->student->middle_name}}</span>
            </h5>
            <h5>School Year: <span class="underline">{{$assessment->enrollment->school_year->school_years}}</span></h5>
        </div>

        <div class="d-flex justify-content-between">
            <h5>Civil Status: <span class="underline-bottom">{{$assessment->student->civil_status}}
                </span></h5>
            <h5>Nationality: <span class="underline-bottom">{{$assessment->student->citizenship}}</span></h5>
        </div>

        <div class="d-flex justify-content-between">
            <h5>Contact Number: <span class="underline-bottom">{{$assessment->student->contact_number}}</span></h5>
            <h5>Grade/Yr & Sec: <span class="underline-bottom">{{$assessment->enrollment->level->level_name}} {{$assessment->enrollment->section->section_name}}</span>
            </h5>
        </div>

        <div class="d-flex justify-content-between">
            <h5>Provincial Address: <span class="underline-bottom">{{$assessment->student->address}}</span></h5>
            <h5>Parents/Guardians: <span class="underline-bottom">Mr(s).
                    {{$assessment->student->guardian->first_name}} {{$assessment->student->guardian->last_name}}</span>
            </h5>
        </div>
    </div>
    ...
    <table class="basic-table">
        ...
        <tbody>
            ...
            <tr>
                <td>{{($row->updated_at) ? date_format($row->updated_at,"F d Y H:i:s") : ''}}</td>
                <td>{{$row->or_number}}</td>
                <td>{{($row->payment_amount) ? "₱ ". $row->payment_amount: ''}}</td>
                <td>{{"₱ ".$fee_amount -= $row->payment_amount}}</td>
            </tr>
            @endforeach
            @for($i = 0; $i < 11 - count($payments); $i++) 
            <tr>
                <td>-</td>
                <td>-</td>
                <td>-</td>
        ...
        <div class="row">
            <div class="col col-5">
                <div class="row">
                    ...
                    {{$assessment->student->middle_name}}
                    </div>
                </div>
            </div>
            <?php 
        ...
        <div class="row">
            ...
            <div class="col col-6">
                <div class="row">
                    ...
                    <div class="col col-9" style="border-bottom: 1px solid black">
                        {{$assessment->student->birth_place}}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col col-6">
                <div class="row">
                    ...
                    <div class="col col-8" style="border-bottom: 1px solid black">
                        Mr(s).
                    {{$assessment->student->guardian->first_name}} {{$assessment->student->guardian->last_name}}
                    </div>
                </div>
            </div>
            <div class="col col-6">
                <div class="row">
                    ...
                    <div class="col col-10" style="border-bottom: 1px solid black">
                        {{$assessment->student->guardian->address}}
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col col-12">
                <div class="row">
                    ...
                    <div class="col col-10" style="border-bottom: 1px solid black">
                        {{$assessment->student->contact_number}}
                    </div>
                </div>
            </div>
        </div>
