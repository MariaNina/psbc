            ...
            <div class="modal-body">
				...
				<form method="post" id="import_excel_form" enctype="multipart/form-data">
					...
					<div class="col col-lg-12">
						<a href="<?php echo e(asset('template/PSBC_STUDENTS_TEMPLATE.xlsx')); ?>">Click to Download Empty Template</a>
					</div>
					<hr>
					<div class="col col-lg-12">
...
<?php /**PATH C:\Users\user\Documents\psbc\resources\views/dashboard/modals/studentsModal.blade.php ENDPATH**/ ?>