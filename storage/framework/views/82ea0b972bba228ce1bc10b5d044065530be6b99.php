						...
						<div class="col-lg-8">
							<div class="form-group">
								...
								<select class="form-control js-example-basic-single" title="No selected student" id="add_student_id"
									...
									<option value="<?php echo e($row->id); ?>" ><?php echo e($row->last_name); ?>,<?php echo e($row->first_name); ?> <?php echo e($row->middle_name); ?> </option>
									...
									<div class="col-lg-4">
										<div class="form-group">
											...
											<select class="form-control" id="add_school_years" name="school_years">
												<option value="" disabled selected>Select...</option>
												<?php $__currentLoopData = $school_years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e($row->id); ?>" <?php if($row->id == $school_year_id): ?>
													<?php echo e('selected'); ?>

													<?php endif; ?>><?php echo e($row->school_years); ?></option>
										...
										<div class="form-group">
											...
											<select class="form-control" id="add_branch" name="branch">
													...
													<?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<option value="<?php echo e($row->id); ?>"><?php echo e($row->branch_name); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
										</div>
									</div>
...
<?php /**PATH C:\Users\user\Documents\psbc\resources\views/dashboard/modals/studentsEnrollmentModal.blade.php ENDPATH**/ ?>