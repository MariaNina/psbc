            ...
            <div class="modal-body">
                <form id="GradeSetForm" role="form" data-toggle="validator">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" required name="grade_range" id="grade_range" class="form-control <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>"  placeholder="eg. 99-100">
                      <?php $__errorArgs = ['grade_range'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
            ...
            <div class="modal-body">
                <form id="editGradeSetForm" role="form" data-toggle="validator">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" required name="grade_range1" id="grade_range1" class="form-control <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH C:\Users\user\Documents\psbc\resources\views/dashboard/modals/gradeSettings.blade.php ENDPATH**/ ?>